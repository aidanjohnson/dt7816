...
cd ~/Downloads
sudo mv libsndfile-1.0.28.tar.gz /opt/ti-sdk-am335x-evm-07.00.00.00/INSTALL/recorder/example-applications
cd /opt/ti-sdk-am335x-evm-07.00.00.00/INSTALL/recorder/example-applications
