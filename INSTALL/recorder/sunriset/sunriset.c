...
/* the horizon.                                                         */
double day_civil_twilight_length(int year, int month, int day, double lon, double lat) {
...
/* below the horizon.                                                   */
double day_nautical_twilight_length(int year, int month, int day, double lon, double lat) {
...
/* below the horizon.                                                      */
double day_astronomical_twilight_length(int year, int month, int day, double lon, double lat) {
...
int sun_rise_set(int year, int month, int day, double lon, double lat, double *start, double *end) {
    return __sunriset__( year, month, day, lon, lat, -35.0/60.0, 1, &(*start), &(*end) );
}
