...
__attribute__((section("__versions"))) = {
	...
	{ 0x75f738bc, __VMLINUX_SYMBOL_STR(platform_get_resource_byname) },
	{ 0x20bd1f0a, __VMLINUX_SYMBOL_STR(sysfs_remove_files) },
	...
	{ 0x20380888, __VMLINUX_SYMBOL_STR(devm_request_and_ioremap) },
